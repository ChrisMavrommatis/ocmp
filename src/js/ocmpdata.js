...
window.dispatchEvent(new CustomEvent("ocmp:init:gtm", {detail: {
	bar: {
		...
		description: 'Χρησιμοποιούμε cookies για την ομαλή λειτουργία του ιστότοπου, τη βελτίωση της εμπειρίας περιήγησης του χρήστη και, υπό τον όρο επιλογής του, την αποθήκευση των προτιμήσεών του. Πολιτική Cookies.'
	},
	modal: {
		title: 'Ρυθμίσεις Cookies',
		description: 'Κατά την απλή περιήγηση ή/και χρήση του ιστότοπου συλλέγουμε αυτόματα δεδομένα σύνδεσης και πληροφορίες σχετικές με την περιήγησή σας, οι οποίες είναι μη εξατομικευμένες και σπάνια περιέχουν προσωποποιημένα χαρακτηριστικά που υποδεικνύουν την ταυτότητά σας. Τα cookies είναι μικρά αρχεία κειμένου τα οποία, μέσω του προγράμματος περιήγησης εγκαθίστανται στον υπολογιστή ή την ηλεκτρονική συσκευή σας, προσθέτοντας λειτουργικότητα στην ιστοσελίδα και βελτιώνοντας την εμπειρία περιήγησης ή, εφ΄ όσον το επιλέξετε, απομνημονεύοντας τις προτιμήσεις σας. Η κατηγορία των απολύτως απαραίτητων cookies για την ομαλή λειτουργία του ιστότοπου είναι η μόνη ενεργοποιημένη. Έχετε τη δυνατότητα να επιλέξετε τις λοιπές κατηγορίες κάνοντας κλικ στο σχετικό κουμπί επάνω δεξιά, αφού ενημερωθείτε σχετικά. Ωστόσο θα πρέπει να γνωρίζετε ότι αποκλεισμός ορισμένων κατηγοριών αρχείων cookies, μπορεί να επηρεάσει την εμπειρία της περιήγησής σας ή/και της χρήσης των υπηρεσιών μας.'
	},
	buttons: {
	...
	consents: [
		{
			...
			content: 'Αυτά είναι τα παραίτητα cookies',
			alwaysOn: true,
		...
		},
		{
			...
			content: 'Αυτά είναι τα λειτουργικά cookies',
		...
		},
		{
			...
			content: 'Αυτά είναι τα cookies στατιστικών',
			defaultState: 'denied',
			cookies: []
		},
		{
			...
			content: 'Αυτά είναι τα cookies διαφήμισης',
			defaultState: 'granted',
			cookies: [
				['_ga', 'Used to distinguish users.', 'Google Analytics', '2 years'],
				['_gid', 'Used to distinguish users.', 'Google Analytics', '24 hours'],
				['_ga_<container-id>', 'Used to persist session state.', 'Google Analytics', '2 years'],
				['_gat_<property-id>', 'Used to throttle request rate.', 'Google Analytics', '1 minute']
			]
		}
	],
	settings: {
